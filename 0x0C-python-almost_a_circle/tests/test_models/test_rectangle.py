...
class TestRectangleMethods(unittest.TestCase):
    """ A suite to test class Rectangle """

    def setUp(self):
        """ A method invoked for each test """
    ...
    def test_incorrect_amount_attrs_1(self):
        """ Test error raise with no arg passed """
        with self.assertRaises(TypeError):
            new = Rectangle()

    def test_access_private_attrs(self):
        """ Test accessing a private attribute """
        new = Rectangle(1, 1)
    ...
    def test_validate_attrs_3(self):
        """ Test passing a string value """
        with self.assertRaises(TypeError):
            new = Rectangle(2, 2, "2", 2, 2)

    def test_validate_attrs_4(self):
        """ Test passing a string value """
        with self.assertRaises(TypeError):
            new = Rectangle(2, 2, 2, "2", 2)
    ...
    def test_area(self):
        """ Check the return value of the area method """
        new = Rectangle(4, 5)
